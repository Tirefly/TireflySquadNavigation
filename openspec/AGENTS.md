...
This OpenSpec workspace lives under `Plugins/TireflySquadNavigation/`.
Unless the user explicitly says otherwise, all OpenSpec operations in this repo target the TSN plugin and should be executed from the plugin directory as the working root.
