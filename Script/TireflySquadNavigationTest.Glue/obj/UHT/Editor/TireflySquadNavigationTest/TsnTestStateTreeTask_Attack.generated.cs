...
/// </summary>
[UStruct, GeneratedType("TsnTestStateTreeTask_Attack", "UnrealSharp.TireflySquadNavigationTest.TsnTestStateTreeTask_Attack")]
public partial struct FTsnTestStateTreeTask_Attack : MarshalledStruct<FTsnTestStateTreeTask_Attack>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnTestStateTreeTask_Attack).GetAssemblyName(), "UnrealSharp.TireflySquadNavigationTest", "TsnTestStateTreeTask_Attack");
    // Name
    ...
    public FTsnTestStateTreeTask_Attack(FName Name, UnrealSharp.StateTreeModule.FStateTreeIndex16 BindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 OutputBindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 InstanceTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeIndex16 ExecutionRuntimeTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeDataHandle InstanceDataHandle, bool TaskEnabled, UnrealSharp.StateTreeModule.EStateTreeTransitionPriority TransitionHandlingPriority, bool ConsideredForCompletion, bool CanEditConsideredForCompletion)
    {
        this.Name = Name;
    ...
    static FTsnTestStateTreeTask_Attack()
    {
    ...
    public FTsnTestStateTreeTask_Attack(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnTestStateTreeTask_Attack FromNative(IntPtr buffer) => new FTsnTestStateTreeTask_Attack(buffer);
...
public static class FTsnTestStateTreeTask_AttackMarshaller
{
    public static FTsnTestStateTreeTask_Attack FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnTestStateTreeTask_Attack(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnTestStateTreeTask_Attack obj)
    {
    ...
    {
        return FTsnTestStateTreeTask_Attack.NativeDataSize;
    }
}