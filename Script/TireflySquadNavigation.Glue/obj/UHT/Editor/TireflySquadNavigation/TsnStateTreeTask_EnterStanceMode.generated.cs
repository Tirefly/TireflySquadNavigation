...
/// 进入站姿模式（一次性任务）
/// </summary>
[UStruct, GeneratedType("TsnStateTreeTask_EnterStanceMode", "UnrealSharp.TireflySquadNavigation.TsnStateTreeTask_EnterStanceMode")]
public partial struct FTsnStateTreeTask_EnterStanceMode : MarshalledStruct<FTsnStateTreeTask_EnterStanceMode>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeTask_EnterStanceMode).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeTask_EnterStanceMode");
    // Name
    ...
    public FTsnStateTreeTask_EnterStanceMode(FName Name, UnrealSharp.StateTreeModule.FStateTreeIndex16 BindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 OutputBindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 InstanceTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeIndex16 ExecutionRuntimeTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeDataHandle InstanceDataHandle, bool TaskEnabled, UnrealSharp.StateTreeModule.EStateTreeTransitionPriority TransitionHandlingPriority, bool ConsideredForCompletion, bool CanEditConsideredForCompletion)
    {
        this.Name = Name;
    ...
    static FTsnStateTreeTask_EnterStanceMode()
    {
    ...
    public FTsnStateTreeTask_EnterStanceMode(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeTask_EnterStanceMode FromNative(IntPtr buffer) => new FTsnStateTreeTask_EnterStanceMode(buffer);
...
public static class FTsnStateTreeTask_EnterStanceModeMarshaller
{
    public static FTsnStateTreeTask_EnterStanceMode FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeTask_EnterStanceMode(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeTask_EnterStanceMode obj)
    {
    ...
    {
        return FTsnStateTreeTask_EnterStanceMode.NativeDataSize;
    }
}