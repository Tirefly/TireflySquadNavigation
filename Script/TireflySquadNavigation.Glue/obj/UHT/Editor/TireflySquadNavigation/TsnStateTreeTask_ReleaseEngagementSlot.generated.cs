...
/// </summary>
[UStruct, GeneratedType("TsnStateTreeTask_ReleaseEngagementSlot", "UnrealSharp.TireflySquadNavigation.TsnStateTreeTask_ReleaseEngagementSlot")]
public partial struct FTsnStateTreeTask_ReleaseEngagementSlot : MarshalledStruct<FTsnStateTreeTask_ReleaseEngagementSlot>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeTask_ReleaseEngagementSlot).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeTask_ReleaseEngagementSlot");
    // Name
    ...
    static FTsnStateTreeTask_ReleaseEngagementSlot()
    {
    ...
    public FTsnStateTreeTask_ReleaseEngagementSlot(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeTask_ReleaseEngagementSlot FromNative(IntPtr buffer) => new FTsnStateTreeTask_ReleaseEngagementSlot(buffer);
...
public static class FTsnStateTreeTask_ReleaseEngagementSlotMarshaller
{
    public static FTsnStateTreeTask_ReleaseEngagementSlot FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeTask_ReleaseEngagementSlot(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeTask_ReleaseEngagementSlot obj)
    {
    ...
    {
        return FTsnStateTreeTask_ReleaseEngagementSlot.NativeDataSize;
    }
}