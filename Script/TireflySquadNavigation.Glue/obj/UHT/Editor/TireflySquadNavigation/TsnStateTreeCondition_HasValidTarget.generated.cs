...
[UStruct, GeneratedType("TsnStateTreeCondition_HasValidTarget", "UnrealSharp.TireflySquadNavigation.TsnStateTreeCondition_HasValidTarget")]
public partial struct FTsnStateTreeCondition_HasValidTarget : MarshalledStruct<FTsnStateTreeCondition_HasValidTarget>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeCondition_HasValidTarget).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeCondition_HasValidTarget");
    // Name
    ...
    static FTsnStateTreeCondition_HasValidTarget()
    {
    ...
    public FTsnStateTreeCondition_HasValidTarget(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeCondition_HasValidTarget FromNative(IntPtr buffer) => new FTsnStateTreeCondition_HasValidTarget(buffer);
...
public static class FTsnStateTreeCondition_HasValidTargetMarshaller
{
    public static FTsnStateTreeCondition_HasValidTarget FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeCondition_HasValidTarget(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeCondition_HasValidTarget obj)
    {
    ...
    {
        return FTsnStateTreeCondition_HasValidTarget.NativeDataSize;
    }
}