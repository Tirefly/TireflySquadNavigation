...
[UStruct, GeneratedType("TsnStateTreeCondition_IsInStanceMode", "UnrealSharp.TireflySquadNavigation.TsnStateTreeCondition_IsInStanceMode")]
public partial struct FTsnStateTreeCondition_IsInStanceMode : MarshalledStruct<FTsnStateTreeCondition_IsInStanceMode>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeCondition_IsInStanceMode).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeCondition_IsInStanceMode");
    // Name
    ...
    public FTsnStateTreeCondition_IsInStanceMode(FName Name, UnrealSharp.StateTreeModule.FStateTreeIndex16 BindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 OutputBindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 InstanceTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeIndex16 ExecutionRuntimeTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeDataHandle InstanceDataHandle, UnrealSharp.StateTreeModule.EStateTreeExpressionOperand Operand, sbyte DeltaIndent, UnrealSharp.StateTreeModule.EStateTreeConditionEvaluationMode EvaluationMode)
    {
        this.Name = Name;
    ...
    static FTsnStateTreeCondition_IsInStanceMode()
    {
    ...
    public FTsnStateTreeCondition_IsInStanceMode(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeCondition_IsInStanceMode FromNative(IntPtr buffer) => new FTsnStateTreeCondition_IsInStanceMode(buffer);
...
public static class FTsnStateTreeCondition_IsInStanceModeMarshaller
{
    public static FTsnStateTreeCondition_IsInStanceMode FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeCondition_IsInStanceMode(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeCondition_IsInStanceMode obj)
    {
    ...
    {
        return FTsnStateTreeCondition_IsInStanceMode.NativeDataSize;
    }
}