...
/// </summary>
[UStruct, GeneratedType("TsnStateTreeTask_ChaseEngagementTarget", "UnrealSharp.TireflySquadNavigation.TsnStateTreeTask_ChaseEngagementTarget")]
public partial struct FTsnStateTreeTask_ChaseEngagementTarget : MarshalledStruct<FTsnStateTreeTask_ChaseEngagementTarget>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeTask_ChaseEngagementTarget).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeTask_ChaseEngagementTarget");
    // Name
    ...
    public FTsnStateTreeTask_ChaseEngagementTarget(FName Name, UnrealSharp.StateTreeModule.FStateTreeIndex16 BindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 OutputBindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 InstanceTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeIndex16 ExecutionRuntimeTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeDataHandle InstanceDataHandle, bool TaskEnabled, UnrealSharp.StateTreeModule.EStateTreeTransitionPriority TransitionHandlingPriority, bool ConsideredForCompletion, bool CanEditConsideredForCompletion)
    {
        this.Name = Name;
    ...
    static FTsnStateTreeTask_ChaseEngagementTarget()
    {
    ...
    public FTsnStateTreeTask_ChaseEngagementTarget(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeTask_ChaseEngagementTarget FromNative(IntPtr buffer) => new FTsnStateTreeTask_ChaseEngagementTarget(buffer);
...
public static class FTsnStateTreeTask_ChaseEngagementTargetMarshaller
{
    public static FTsnStateTreeTask_ChaseEngagementTarget FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeTask_ChaseEngagementTarget(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeTask_ChaseEngagementTarget obj)
    {
    ...
    {
        return FTsnStateTreeTask_ChaseEngagementTarget.NativeDataSize;
    }
}