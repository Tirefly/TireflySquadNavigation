...
[UStruct, GeneratedType("TsnStateTreeCondition_IsInEngagementRange", "UnrealSharp.TireflySquadNavigation.TsnStateTreeCondition_IsInEngagementRange")]
public partial struct FTsnStateTreeCondition_IsInEngagementRange : MarshalledStruct<FTsnStateTreeCondition_IsInEngagementRange>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeCondition_IsInEngagementRange).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeCondition_IsInEngagementRange");
    // Name
    ...
    static FTsnStateTreeCondition_IsInEngagementRange()
    {
    ...
    public FTsnStateTreeCondition_IsInEngagementRange(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeCondition_IsInEngagementRange FromNative(IntPtr buffer) => new FTsnStateTreeCondition_IsInEngagementRange(buffer);
...
public static class FTsnStateTreeCondition_IsInEngagementRangeMarshaller
{
    public static FTsnStateTreeCondition_IsInEngagementRange FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeCondition_IsInEngagementRange(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeCondition_IsInEngagementRange obj)
    {
    ...
    {
        return FTsnStateTreeCondition_IsInEngagementRange.NativeDataSize;
    }
}