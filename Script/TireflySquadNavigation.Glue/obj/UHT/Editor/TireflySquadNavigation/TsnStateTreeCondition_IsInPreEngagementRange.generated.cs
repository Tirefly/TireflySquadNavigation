...
[UStruct, GeneratedType("TsnStateTreeCondition_IsInPreEngagementRange", "UnrealSharp.TireflySquadNavigation.TsnStateTreeCondition_IsInPreEngagementRange")]
public partial struct FTsnStateTreeCondition_IsInPreEngagementRange : MarshalledStruct<FTsnStateTreeCondition_IsInPreEngagementRange>
{
    static readonly IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetType(typeof(FTsnStateTreeCondition_IsInPreEngagementRange).GetAssemblyName(), "UnrealSharp.TireflySquadNavigation", "TsnStateTreeCondition_IsInPreEngagementRange");
    // Name
    ...
    public FTsnStateTreeCondition_IsInPreEngagementRange(FName Name, UnrealSharp.StateTreeModule.FStateTreeIndex16 BindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 OutputBindingsBatch, UnrealSharp.StateTreeModule.FStateTreeIndex16 InstanceTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeIndex16 ExecutionRuntimeTemplateIndex, UnrealSharp.StateTreeModule.FStateTreeDataHandle InstanceDataHandle, UnrealSharp.StateTreeModule.EStateTreeExpressionOperand Operand, sbyte DeltaIndent, UnrealSharp.StateTreeModule.EStateTreeConditionEvaluationMode EvaluationMode)
    {
        this.Name = Name;
    ...
    static FTsnStateTreeCondition_IsInPreEngagementRange()
    {
    ...
    public FTsnStateTreeCondition_IsInPreEngagementRange(IntPtr InNativeStruct)
    {
        unsafe
        {
    ...
    public static FTsnStateTreeCondition_IsInPreEngagementRange FromNative(IntPtr buffer) => new FTsnStateTreeCondition_IsInPreEngagementRange(buffer);
...
public static class FTsnStateTreeCondition_IsInPreEngagementRangeMarshaller
{
    public static FTsnStateTreeCondition_IsInPreEngagementRange FromNative(IntPtr nativeBuffer, int arrayIndex)
    {
        return new FTsnStateTreeCondition_IsInPreEngagementRange(nativeBuffer + (arrayIndex * GetNativeDataSize()));
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, FTsnStateTreeCondition_IsInPreEngagementRange obj)
    {
    ...
    {
        return FTsnStateTreeCondition_IsInPreEngagementRange.NativeDataSize;
    }
}